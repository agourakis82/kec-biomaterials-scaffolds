...
async def demo_h4_complete_system():
    ...
    try:
        ...
        h3_status = (
            hasattr(executor, "h3_api_client") and executor.h3_api_client is not None
        )
...
async def demo_h4_advanced_features():
    ...
    try:
        from kec_biomat_api.data_processing.config import (
...
async def main():
    ...
    results = [("Demo Básica", success_basic), ("Demo Avançada", success_advanced)]
