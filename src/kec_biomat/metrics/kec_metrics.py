...
Migrado e consolidado de kec_biomat_api.logic.kec_metrics
"""
...
def compute_kec_metrics(G: nx.Graph,
    ...
    Args:
        G: NetworkX graph representando estrutura porosa
        spectral_k: Número de autovalores para entropia espectral
        include_triangles: Se inclui triângulos na curvatura de Forman
        n_random: Número de grafos aleatórios para small-world metrics
        sigma_q: Se calcula coerência quântica σ_Q
        
    Returns:
        Dict com métricas KEC 2.0: H_spectral, k_forman_*, sigma, swp, [sigma_Q]
    """
