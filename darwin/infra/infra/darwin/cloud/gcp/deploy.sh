...
gcloud run deploy "$SERVICE" \
  ...
  --set-env-vars "GCP_PROJECT_ID=${PROJECT_ID},GCP_REGION=${REGION},VECTOR_BACKEND=gcp_bq,BQ_DATASET=pcs_helio_kb,BQ_TABLE=documents,DISCOVERY_FROM_SECRET=true" \
...
# Ensure public access is properly set
echo "Setting Cloud Run IAM policy for public access..."
